...
const FileList = ({ documents, loading }) => {
    if (loading) {
        return (
                        ...
                        {documents.map((doc) => (
                            <tr key={doc.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-3 py-2 sm:px-5 sm:py-4 whitespace-nowrap text-sm">
                                    <span className={`px-2 py-1 rounded-full text-xs ${doc.status === 'Đã ký' ? 'bg-green-100 text-green-800' :
                                ...
                                <td className="px-3 py-2 sm:px-5 sm:py-4">
                                    <div className="flex flex-wrap gap-2">
                                        <button
                                            onClick={() => alert(`Xem chi tiết: ${doc.name}`)}
                                        ...
                                        <button
                                            onClick={() => alert(`Xác thực: ${doc.name}`)}
